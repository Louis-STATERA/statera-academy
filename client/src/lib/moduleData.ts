...
export const MODULES: Module[] = [
  ...
  {
    id: 'rgpd',
    title: 'Données Sous Protection',
    subtitle: 'Mission 6 — RGPD & Protection des Données',
    description: 'Comprenez les principes du RGPD, les droits des personnes et les obligations de l\'entreprise pour protéger les données personnelles au quotidien.',
    image: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663343017296/FPbfJCyecKtnym4RKQrEZz/flat-rgpd-oFdb8Ydo5k4K4dJHZmf74k.webp',
    color: '#a78bfa',
    glowClass: 'glow-cyan',
    duration: '5 min',
    difficulty: 'Intermédiaire',
    xpReward: 180,
    keyFact: { stat: '4%', description: 'du chiffre d\'affaires mondial : amende maximale en cas de violation du RGPD' },
    learningPoints: [
      { icon: '📋', title: 'Qu\'est-ce que le RGPD ?', description: 'Le Règlement Général sur la Protection des Données (2018) encadre la collecte, le traitement et le stockage des données personnelles des citoyens européens. Il s\'applique à toute entreprise traitant ces données.' },
      { icon: '👤', title: 'Données personnelles', description: 'Toute information identifiant directement ou indirectement une personne : nom, email, adresse IP, numéro de téléphone, données de localisation, identifiants en ligne, données biométriques.' },
      { icon: '⚖️', title: 'Les droits des personnes', description: 'Droit d\'accès, de rectification, d\'effacement ("droit à l\'oubli"), de portabilité, d\'opposition et de limitation du traitement. Chaque salarié doit savoir orienter une demande d\'exercice de droits.' },
      { icon: '🔔', title: 'Notification de violation', description: 'En cas de fuite de données, l\'entreprise a 72 heures pour notifier la CNIL. Les personnes concernées doivent aussi être informées si le risque est élevé. Chaque minute compte.' },
    ],
    questions: [
      {
        id: 'rg1', type: 'multiple-choice', difficulty: 'easy',
        question: 'Parmi ces informations, laquelle N\'EST PAS une donnée personnelle au sens du RGPD ?',
        options: [
          { id: 'a', text: 'L\'adresse email professionnelle d\'un salarié', isCorrect: false },
          { id: 'b', text: 'Le numéro SIRET d\'une entreprise', isCorrect: true },
          { id: 'c', text: 'L\'adresse IP d\'un visiteur de site web', isCorrect: false },
          { id: 'd', text: 'La photo d\'un badge d\'accès', isCorrect: false },
        ],
        explanation: 'Le numéro SIRET identifie une entreprise (personne morale), pas une personne physique. Les emails professionnels, adresses IP et photos de badge permettent d\'identifier un individu et sont donc des données personnelles.',
      },
      {
        id: 'rg2', type: 'scenario', difficulty: 'medium',
        question: 'Un client vous envoie un email demandant la suppression de toutes ses données personnelles de vos systèmes. Que faites-vous ?',
        options: [
          { id: 'a', text: 'Je supprime immédiatement toutes ses données de mon ordinateur', isCorrect: false },
          { id: 'b', text: 'Je transfère la demande au DPO (Délégué à la Protection des Données) de l\'entreprise', isCorrect: true },
          { id: 'c', text: 'Je réponds au client que ce n\'est pas possible', isCorrect: false },
          { id: 'd', text: 'J\'ignore la demande car elle ne concerne pas mon service', isCorrect: false },
        ],
        explanation: 'Le droit à l\'effacement ("droit à l\'oubli") est un droit fondamental du RGPD. Toute demande doit être transmise au DPO qui évaluera si des obligations légales (comptabilité, contrat) imposent de conserver certaines données.',
      },
      {
        id: 'rg3', type: 'true-false', difficulty: 'easy',
        question: 'Le RGPD ne s\'applique qu\'aux entreprises de plus de 250 salariés.',
        options: [
          { id: 'a', text: 'Vrai', isCorrect: false },
          { id: 'b', text: 'Faux', isCorrect: true },
        ],
        explanation: 'Faux ! Le RGPD s\'applique à TOUTE organisation, quelle que soit sa taille, dès lors qu\'elle traite des données personnelles de résidents européens. Les TPE/PME sont tout autant concernées.',
      },
      {
        id: 'rg4', type: 'scenario', difficulty: 'hard',
        question: 'Vous découvrez qu\'un fichier Excel contenant les noms, emails et salaires de 200 collaborateurs a été accidentellement partagé sur un dossier accessible à tous. Que faites-vous en priorité ?',
        options: [
          { id: 'a', text: 'Je supprime le fichier et je n\'en parle à personne pour éviter la panique', isCorrect: false },
          { id: 'b', text: 'J\'alerte immédiatement le DPO et le responsable IT pour qu\'ils évaluent la violation et notifient la CNIL si nécessaire', isCorrect: true },
          { id: 'c', text: 'J\'envoie un email à tous les collaborateurs pour les prévenir', isCorrect: false },
          { id: 'd', text: 'Je restreins les accès au dossier et j\'attends la prochaine réunion d\'équipe pour en parler', isCorrect: false },
        ],
        explanation: 'C\'est une violation de données personnelles. L\'entreprise a 72h pour notifier la CNIL. Le DPO et le responsable IT doivent être alertés immédiatement pour évaluer l\'étendue de la fuite, sécuriser les données et décider de la notification.',
      },
      {
        id: 'rg5', type: 'multiple-choice', difficulty: 'medium',
        question: 'Quel est le délai légal pour répondre à une demande d\'exercice de droits RGPD (accès, rectification, suppression) ?',
        options: [
          { id: 'a', text: '72 heures', isCorrect: false },
          { id: 'b', text: '1 mois maximum (extensible à 3 mois pour les demandes complexes)', isCorrect: true },
          { id: 'c', text: '15 jours ouvrés', isCorrect: false },
          { id: 'd', text: 'Aucun délai imposé par la loi', isCorrect: false },
        ],
        explanation: 'Le RGPD impose un délai de réponse d\'1 mois maximum, extensible à 3 mois pour les demandes complexes (avec information du demandeur du délai supplémentaire). Le délai de 72h concerne uniquement la notification de violation à la CNIL.',
      },
    ],
  },
  {
    ...
    description: 'Testez l\'ensemble de vos connaissances avec ce quiz final couvrant toutes les menaces et le RGPD. Obtiendrez-vous le grade de Cyber-Sentinelle ?',
    ...
    learningPoints: [
      { icon: '🏆', title: 'Évaluation complète', description: 'Ce quiz final couvre l\'ensemble des 6 modules précédents, y compris le RGPD. Il teste votre capacité à réagir face à des situations réalistes et variées.' },
...
export const BADGES = [
  ...
  { id: 'rgpd-guardian', title: 'Gardien des Données', description: 'Compléter le module RGPD', icon: '📋' },
